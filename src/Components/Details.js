...
export default class Details extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`${API_URL}/api/getRestaurantsById/${id}`)
            .then(result => {
                this.setState({
                    restaurant: result.data.restaurants[0]
                  
                });
                console.log(this.state.restaurant,"resta");
            })
            .catch(error => {
                console.log(error);
            });
    ...
    paymentHandler = () => {
        ...
        const data = {
            ...
            email: 'manideepabbidi@gmail.com',
            mobileNo: '9999999999'
        };
